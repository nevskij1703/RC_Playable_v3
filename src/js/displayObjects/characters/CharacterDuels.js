...
export default class CharacterDuels extends Container {
  ...
  getDefaultConfig(config) {
    const {spineConfig = {}, car_back = {}, car_front = {}} = config;
    return Object.assign(super.getDefaultConfig(config), {
      ...
      animations: {
        ...
        hide: {
          from: {alpha: 1},
          to: {alpha: 0},
          duration: TIMINGS.characterMoveOut*.5,
          easing: Easing.Quintic.Out
        }
      },
      children: [
        Object.assign({}, car_back),
        Object.assign({
          name: "spine",
          class: Spine,
